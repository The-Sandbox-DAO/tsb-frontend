...
function CreateChart() {
    ...
    const months = ["Sept 24", "Oct 24", "Nov 24", "Dec 24"]; //nodes.map(node => node.range); //["Sept", "Oct", "Nov", "Dec"],
    const revenues = [15887,111751, 343858, 6373];//nodes.map(node => node.usd); //[10280, 299378, 7422539, 5344214, 481854]
